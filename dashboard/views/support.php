            ...
            <div class="card-search-box hoverable white">
                <form action="" method="GET" id="form-filtro">
                    <div class="input-field">
                        <input id="icon_prefix" type="text" class="validate filtro" name="filtro" placeholder="Buscar FAQ">
                    </div>
                </form>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col s12">
                                    <div class="card-title-inline">
                                        <span class="card-title">Gestión de Soporte tecnico</span>
                                    </div>
                                </div>
                            </div>
                            <table class="bordered highlight responsive-table" id="users">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Mi compra no se completa</td>
                                        <td>Revise los datos de su tarjeta</td>
                                        <td>
                                            <a href="#nuevaFAQ" onclick="" class="edit modal-trigger">
                                    ...
                                    <tr>
                                        ...
                                        <td>Como se si mi juego es compatible con mi sistema?</td>
                                        <td>Refierase a la seccion "disponible para" de la pagina del juego</td>
                                        <td>
                                            <a href="#nuevaFAQ" onclick="" class="edit modal-trigger">
                                                <i class="material-icons tooltipped editar" data-position="left" data-delay="50">mode_edit</i>
                                            </a>
                                    ...
                                    <tr>
                                        ...
                                        <td>Como puedo ver las ofertas?</td>
                                        <td>En la seccion "ofertas de la pagina principal de juegos"</td>
                                        <td>
                                            <a href="#nuevaFAQ" onclick="" class="edit modal-trigger">
                                                <i class="material-icons tooltipped editar" data-position="left" data-delay="50">mode_edit</i>
                                            </a>
    ...
    <div class="modal-content">
        ...
        <div class="row">
            <div class="col s12 m8 offset-m2 center-align">
                <form id="frmRegEsrb" action="#">
                    <div class="input-field">
                        <input id="registerUser" type="text" required>
                        <label for="registerUser">Pregunta</label>
                    </div>
